...
This file preserves historical README material from the theme lineage that came before the current TypeScript-based Kawaii VS Code Color extension. Current usage, development, packaging, and architecture notes live in [README.md](./README.md).

The archive is chronological:

1. Early upstream README: manual Custom CSS and JS workflow.
2. Later upstream README: built-in Neon Dreams workflow.

Some historical links, screenshots, commands, and package names are preserved as they were written at the time and do not describe the current extension.

## 1. Early upstream README: manual Custom CSS workflow
