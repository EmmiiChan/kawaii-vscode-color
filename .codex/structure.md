...
| --- | --- | --- | --- |
| Theme build layer | Preserves the dark and light base themes and applies Kawaii-specific overrides before VS Code loads either theme | Protected base themes, editable override themes | `themes/kawaii_synthwave-generated-color-theme.json`, `themes/kawaii_synthwave-generated-color-theme-light.json` |
...
- Protected dark upstream/base palette and token rules live in `themes/kawaii_synthwave-color-theme.json`.
- Protected light base palette and token rules live in `themes/kawaii_synthwave-color-theme-light.json`.
- Dark Kawaii palette and token changes must be placed in `themes/kawaii_synthwave-color-theme-overrides.json`.
