...
3. For theme colors, edit only the relevant public color pack in `themes/`, validate color IDs in [Theme Color reference](https://code.visualstudio.com/api/references/theme-color), then run `npm run build:theme`.
