...
| Theme core bases, public color packs, generated theme files, colors, tokenColors, semanticTokenColors, or color reference behavior | Update `.codex/color_scheme_reference.md`, `.codex/structure.md`, and `.codex/system-map.md`. Run `npm run build:theme` and `npm run test:docs`. |
