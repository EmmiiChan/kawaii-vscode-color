...
| Theme core bases, public color packs, generated theme files, remote theme update behavior, colors, tokenColors, semanticTokenColors, or color reference behavior | Update `.codex/color_scheme_reference.md`, `.codex/structure.md`, and `.codex/system-map.md`. Run `npm run build:theme`, `npm run update:themes -- --dry-run` when network validation is relevant, and `npm run test:docs`. |
